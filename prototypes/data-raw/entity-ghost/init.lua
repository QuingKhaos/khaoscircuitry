return {
  ...
  ["tree-dying-proxy"] = require("___KHAOSDATA___.prototypes.data-raw.entity-ghost.tree-dying-proxy"),
  ["tree-proxy"] = require("___KHAOSDATA___.prototypes.data-raw.entity-ghost.tree-proxy"),
}
