return {
  ...
  graphics_set = {
    animation = {
      layers = {
        {
          filename = "__base__/graphics/entity/assembling-machine-3/assembling-machine-3-base.png",
          height = 192,
          line_length = 1,
          priority = "high",
          repeat_count = 64,
        ...
        {
          filename = "__base__/graphics/entity/assembling-machine-3/assembling-machine-3-anim.png",
          frame_count = 64,
          height = 160,
          line_length = 8,
          priority = "high",
    ...
    working_visualisations = {
      {
        animation = {
          blend_mode = "additive",
          draw_as_glow = true,
          filename = "__base__/graphics/entity/assembling-machine-3/assembling-machine-3-status-light.png",
          height = 44,
          line_length = 1,
          priority = "high",
          repeat_count = 64,
