return {
  ...
  heating_energy = "50kW",
  icon = "__alchemical-combinator__/graphics/icons/alchemical-combinator-active.png",
  ...
  sprites = {
    east = {
      layers = {
        {
          filename = "__alchemical-combinator__/graphics/entity/combinator/alchemical-combinator-active.png",
          height = 132,
          priority = "high",
          scale = 0.5,
          shift = {
