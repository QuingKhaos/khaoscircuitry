return {
  ...
  and_symbol_sprites = {
    east = {
      draw_as_glow = true,
      filename = "__filter-combinator-improved__/graphics/hr-filter-combinator-improved-display.png",
      height = 22,
      scale = 0.5,
      shift = {
        0,
  ...
  minable = {
    mining_time = 0.1,
    result = "hps__fc-filter-combinator"
  },
  ...
  name = "hps__fc-filter-combinator",
  open_sound = {
