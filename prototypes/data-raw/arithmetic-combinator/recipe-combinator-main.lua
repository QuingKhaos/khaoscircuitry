return {
  ...
  factoriopedia_description = {
    "factoriopedia-description.recipe-combinator-main"
  },
  ...
  placeable_by = {
    count = 1,
    item = "recipe-combinator-main"
  },
  plus_symbol_sprites = {
    east = {
      draw_as_glow = true,
      filename = "__recipe_combinator__/graphics/rled.png",
      height = 22,
      scale = 0.5,
      shift = {
        0,
