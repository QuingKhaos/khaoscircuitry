return {
  ...
  ["small-equipment-grid"] = require("___KHAOSDATA___.prototypes.data-raw.equipment-grid.small-equipment-grid"),
  ["spidertron-equipment-grid"] = require("___KHAOSDATA___.prototypes.data-raw.equipment-grid.spidertron-equipment-grid"),
}
