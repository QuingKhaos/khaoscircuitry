...
require("__khaoscircuitry__.settings.tweaks.br-combinator")
...
require("__khaoscircuitry__.settings.tweaks.signal-lamp")
require("__khaoscircuitry__.settings.tweaks.simple-gauge")
require("__khaoscircuitry__.settings.tweaks.smart-train-combinator")
require("__khaoscircuitry__.settings.tweaks.space-platform-flow-monitor")
