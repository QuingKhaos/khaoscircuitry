...
Set-Variable -Name package -Value "khaoscircuitry"
...
Move-Item -Path "$workspace\khaoscircuitrygroup\khaoscircuitrygroup_$version_khaoscircuitrygroup.zip" -Destination "$mod_base" -Force -ErrorAction SilentlyContinue
