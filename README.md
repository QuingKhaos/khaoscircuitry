...
[![GitHub issues: bugs](https://img.shields.io/github/issues/QuingKhaos/khaoscircuitry/bug?label=Bug%20Reports&style=for-the-badge&logo=github)](https://github.com/QuingKhaos/khaoscircuitry/issues?q=is%3Aissue%20state%3Aopen%20label%3Abug)
[![GitHub pull requests](https://img.shields.io/github/issues-pr/QuingKhaos/khaoscircuitry?label=Pull%20Requests&style=for-the-badge&logo=github)](https://github.com/QuingKhaos/khaoscircuitry/pulls)
...
All circuitry stuff is properly sorted into its own tab if [QuingKhaos' Circuitry Group](https://mods.factorio.com/mod/khaoscircuitrygroup)
or [Schall Circuit Group](https://mods.factorio.com/mod/SchallCircuitGroup)ᵃ is installed.
...
ᵃ: As of 2026-07-18 this mod is not yet available for Factorio 2.1. The tweaks for this mod are still included, so if the
mod is updated for Factorio 2.1, the tweaks will be applied automatically.
